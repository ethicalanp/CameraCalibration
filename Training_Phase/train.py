...
# python train.py --batch 8 --epochs 5 --cfg models/yolov5l6.yaml --hyp data/hyp.single.yaml --weights weights/yolov5l6.pt --data data/Mouse.yaml --rect --cache --optimizer Adam 